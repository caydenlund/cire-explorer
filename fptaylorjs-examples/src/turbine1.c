...
FPC_CALCULATE_ERROR float turbine1(float v, float w, float r) {
    float r_sq = r * r;
    float term1 = 2.0f / r_sq;
    float temp1 = 2.0f * v;
    float temp2 = 3.0f - temp1;
    float w_sq = w * w;
...
int main() {
    float v = -0.30000000000000004f;
    float w = 0.9f;
    float r = 7.800000000000001f;
    float result = turbine1(v, w, r);
    printf("turbine1(v, w, r) = %f\n", result);
    return 0;
}

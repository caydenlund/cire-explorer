; ModuleID = 'src/logexp.c'
source_filename = "src/logexp.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str = private unnamed_addr constant [16 x i8] c"logexp(x) = %f\0A\00", align 1

; Function Attrs: mustprogress nofree nounwind willreturn memory(write) uwtable
define dso_local float @logexp(float noundef %x) local_unnamed_addr #0 {
entry:
  %call = tail call float @expf(float noundef %x) #4, !tbaa !5
  %add = fadd float %call, 1.000000e+00
  %call1 = tail call float @logf(float noundef %add) #4
  ret float %call1
}
...
entry:
  %call1 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef 0x4020002C00000000)
  ret i32 0
}

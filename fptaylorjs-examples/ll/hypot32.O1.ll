; ModuleID = 'src/hypot32.c'
source_filename = "src/hypot32.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str = private unnamed_addr constant [22 x i8] c"hypot32(x1, x2) = %f\0A\00", align 1

; Function Attrs: mustprogress nofree nounwind willreturn memory(write) uwtable
define dso_local float @hypot32(float noundef %x1, float noundef %x2) local_unnamed_addr #0 {
entry:
...
entry:
  %call1 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef 0x4061AD7BC0000000)
  ret i32 0
}
